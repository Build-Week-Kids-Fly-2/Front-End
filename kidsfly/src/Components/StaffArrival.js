...
const StaffArrivalStyle =styled.div`
.onduty{
    margin: 30px;
    width: 327px;
    height: 702px;
...
const StaffArrival = () => {
  ...
  <div className="content">
            ...
            <section className="arrival">
                <div className="btns2">
            <button className="btns3 btns">Arrived</button><button className="btns">Upcoming</button>
                </div>
                ...
                <div className="staffarrive">
                    ...
                    <div className="times">
                        <p>7:30  am </p>
                        <p>Jensens Family</p>
                        <p>Arrivals Gate 13</p>
                        <p>BA11</p>
                        <p>Arrived</p>
                    </div>
                    <div className="staff">
                        <img src={Manesh} alt="Dani"/>
